  ...
  stages {
    ...
    stage('CD - Deploy Containers'){
      steps {
        ...
        slackSend (color: '#00FF00', message: "@channel *APP DEPLOYED:* Best Buy App (Samuel Baruffi) (ENV=DEV) (http://${public_dns}:8091)")
        ...
        slackSend (color: '#00FF00', message: "@channel *APP DEPLOYED:* Best Buy App (Samuel Baruffi) (ENV=TEST) (http://${public_dns}:8092)")
        ...
        slackSend (color: '#00FF00', message: "@channel *APP DEPLOYED:* Best Buy App (Samuel Baruffi) (ENV=DR) (http://${public_dns}:8093)")
        ...
        slackSend (color: '#00FF00', message: "@channel *APP DEPLOYED:* Best Buy App (Samuel Baruffi) (ENV=PROD) (http://${public_dns}:8094)")
      }      
    }
   }
